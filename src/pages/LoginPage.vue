    ...
    <div class="full-width column">
      ...
      <div class="bg-animated column q-pt-xl q-pb-lg q-px-md relative-position">
        ...
        <div class="row items-center q-gutter-xs relative-position" style="z-index: 1">
          <span class="text-white-7 text-body2">Don't have an account?</span>
          <router-link
            to="/register"
        ...
        <form @submit.prevent="handleSubmit" class="full-width">
          ...
          <div class="row justify-between items-center q-mb-lg">
            <div class="row items-center q-gutter-x-xs">
              ...
              <span class="text-caption text-grey-7 text-weight-medium">Remember me</span>
            </div>
            <router-link
              to="/forgot-password"
          ...
          <div class="row items-center q-mb-md">
            ...
            <span class="q-mx-md text-caption text-grey-7">Or login with</span>
            <div class="col bg-grey-3" style="height: 1px"></div>
          </div>
      ...
      <p class="text-center text-caption text-grey-7 q-mt-sm q-px-md">
        ...
        <span class="text-dark no-decoration">Terms of Service</span> and
        <span class="text-dark no-decoration">Data Processing Agreement</span>
      </p>
    </div>
  </q-page>
</template>
